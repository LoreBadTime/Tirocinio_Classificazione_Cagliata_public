...
for i = 1:length(setnums)
    ...
    DataPath = 'F:\Download\Tirocinio-Classificazione-Cagliata\1_Processed\'+ setnum + "\"+ setnum + chosenset;
    %%Parte sul merge
    features_container = [];
    ...
    tsne_model_container = [tsne_model_container;features_container];
...
modelname = "mergedFeatures" + usedset;
