...
To run the mutual information test equivalence between matlab and scipy omplementation you need to install scipy and numpy, otherwise the test is skipped and its just normally used the matlab version.
## Run Locally
